        ...
        <div>
             <transition name="raise">
                <div v-if="detailsOpen" class="details">
                        <div class="details__title">The Laurelwood Home</div>
        ...
        <div>
         ...
         <div class="info">
            <div class="info__container">
                ...
                <div>
                    <div class="info-title">The Laurelwood Home</div>
                    <div class="info__desc">2,178 SQ FEET / 3 BED / 3 BATH / $499k</div>
                </div>
...
export default {
    ...
    data() {
        return {
            theBackgroundImage: 'url("../src/assets/homes/home3/home3-hero.jpg") !important',
            home: 'Laurelwood',
            detailsOpen: false,
            optionsOpen: false,
            floorPlanOpen: false,
    ...
    methods: {
        ...
        optionSelected(option) {
            this.optionsOpen = false
            this.$store.commit('setHomeSelection', {home: 'Laurelwoodgo', option: option})

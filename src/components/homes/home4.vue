        ...
        <div>
         ...
         <div class="info">
            <div class="info__container">
                ...
                <div>
                    <div class="info-title">The Willamette Home</div>
                    <div class="info__desc">2,178 SQ FEET / 2 BED / 1.5 BATH / $375k</div>
                </div>
...
export default {
    ...
    data() {
        return {
            theBackgroundImage: 'url("../src/assets/homes/home4/home4-hero.jpg") !important',
            home: 'Willamette',
            detailsOpen: false,
            optionsOpen: false,
            floorPlanOpen: false,
    ...
    methods: {
        ...
        optionSelected(option) {
            this.optionsOpen = false
            this.$store.commit('setHomeSelection', {home: 'Willamettego', option: option})
